    ...
    <div>
      ...
      <div className="relative z-10 container mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-3 rounded-lg shadow-lg max-w-lg mx-auto">
          ...
          <button
            type="submit"
            className="w-full bg-white text-black py-3 px-4 rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-transform transform hover:scale-105"
          >
            Submit Report
          </button>
