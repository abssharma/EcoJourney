    ...
    <div>
      ...
      <div>
        <header className="relative text-center mb-16 w-6">
          <br/>
          <h1 className="text-8xl font-extrabold text-white mt-6">ECO JOURNEY</h1>
        </header>
        <section className="px-10 py-100 grid lg:grid-cols-3 gap-6 p-18 mt-16">

          
        
        <div className="bg-white hover:bg-green-600 p-8 rounded-xl shadow-xl transition-transform transform hover:scale-105 hover:shadow-2xl flex flex-col justify-between">
          <div>
          ...
          <div className="bg-white hover:bg-green-600 rounded-xl shadow-lg transition-transform transform hover:scale-105 hover:shadow-xl flex flex-col justify-between p-8 mt-16">
            <div>
